...
public class ExportTest {
    ...
    public void testGenerateSource() throws Exception {
        final DbClient db = new DbClient(new SimpleDataSource("jdbc:mysql://api.hikvision.com.cn:3306/api", "root", "88075998"));
    ...
    public void testExporterData() throws Exception {
        ...
        ex.doxport(db, "com.github.geequery.codegen.entity", new File(System.getProperty("user.dir"), "src/test/resources"));
        db.shutdown();
    }
    ...
    public void testInitData() {
        ...
        qe.setInitDataAfterCreate(true);
        qe.setInitDataIfTableExists(false);
        qe.setEntityManagerFactory(new JefEntityManagerFactory(db));
